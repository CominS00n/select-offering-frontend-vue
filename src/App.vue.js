...
function __VLS_template() {
  ...
  __VLS_elementAsFunction(
    ...
    __VLS_intrinsicElements.header
  )({ id: 'header', ...{ class: 'space-y-3 py-3 px-6 rounded-md' } })
  __VLS_elementAsFunction(
    __VLS_intrinsicElements.h1,
    __VLS_intrinsicElements.h1
  )({ ...{ class: 'text-2xl font-bold uppercase text-[#F7C906] tracking-[.25rem] mb-6' } })
  __VLS_elementAsFunction(
  ...
  const __VLS_0 = __VLS_asFunctionalComponent(
    muliComboBox,
    new muliComboBox({ ...{ onDataSelected: {} } })
  )
  ...
  const __VLS_7 = __VLS_asFunctionalComponent(
    subscriberPage,
    new subscriberPage({ ...{ onDataSelected: {} } })
  )
  ...
  __VLS_elementAsFunction(
    ...
    ...{ onClick: __VLS_ctx.sendData },
    type: 'submit',
    ...{
      class:
        'w-full bg-[#F7C906] py-2 rounded-md font-semibold hover:transition hover:bg-[#f7cb06c3] text-white hover:duration-300 hover:ease-in-out hover:bg-white hover:text-[#F7C906] hover:outline hover:outline-[1px] hover:outline-[#F7C906]'
    }
  })
  // @ts-ignore
  ;[sendData]
  __VLS_elementAsFunction(
    ...
    ...{ class: 'py-3 px-6 space-y-5 bg-white rounded-md mt-2 min-h-80 h-screen overflow-hidden' }
  })
  ...
  const __VLS_19 = __VLS_asFunctionalComponent(
    dataTable,
    new dataTable({ dataValue: __VLS_ctx.userList, totalPages: __VLS_ctx.totalCount })
  )
