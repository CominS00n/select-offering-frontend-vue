SELECT
 ...
 CASE WHEN DEF_ACCT.PAYMENT_MODE = 0 THEN 'Prepaid'
 WHEN DEF_ACCT.PAYMENT_MODE = 1 THEN 'Postpaid'
 ELSE DEF_ACCT.PAYMENT_MODE END AS PAYMENT_MODE,
 CASE WHEN SUB.STATUS = 1 THEN 'Idle'
