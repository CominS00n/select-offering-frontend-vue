...
const { defineSlots, defineEmits, defineExpose, defineModel, defineOptions, withDefaults } =
  await import('vue')
...
function __VLS_template() {
  ...
  __VLS_elementAsFunction(
    ...
    __VLS_intrinsicElements.section
  )({ ...{ class: 'flex flex-col w-full h-full space-y-3 bg-white overflow-hidden' } })
  if (__VLS_ctx.loading) {
    // @ts-ignore
    const __VLS_0 = {}.loadingPage
    ;({}).loadingPage
  ...
  __VLS_elementAsFunction(
    ...
    ...{ class: __VLS_ctx.totalPages === 0 ? 'sm:justify-end' : 'sm:justify-between' }
  })
  ...
  if (__VLS_ctx.totalPages > 0) {
    ...
    __VLS_elementAsFunction(
      ...
      ...{ class: 'export inline-flex justify-center items-center' }
    })
    // @ts-ignore
    const __VLS_6 = {}.DocumentArrowUpIcon
    ;({}).DocumentArrowUpIcon
    ...
    const __VLS_7 = __VLS_asFunctionalComponent(
      __VLS_6,
      new __VLS_6({ ...{ class: 'icon h-5 w-5' } })
    )
  ...
  for (const [item] of __VLS_getVForSourceType(__VLS_ctx.limitList)) {
    __VLS_elementAsFunction(
      ...
      __VLS_intrinsicElements.option
    )({ ...{ onChange: item.value }, key: item.name, value: item.value })
    item.name
    // @ts-ignore
    ;[limit, limitList]
  }
  if (__VLS_ctx.totalPages > 0) {
    ...
    __VLS_elementAsFunction(
      ...
      ...{
        class:
          'border-slate-300 border-l border-y rounded-s-full w-8 h-full flex justify-center items-center cursor-pointer'
      },
      ...{ class: __VLS_ctx.currentPage === 1 ? 'bg-gray-100' : '' },
      disabled: __VLS_ctx.currentPage === 1
    })
    __VLS_styleScopedClasses = currentPage === 1 ? 'bg-gray-100' : ''
    // @ts-ignore
    const __VLS_12 = {}.ChevronLeftIcon
    ;({}).ChevronLeftIcon
    ...
    __VLS_elementAsFunction(
      ...
      ...{
        class:
          'flex justify-center items-center border border-slate-300 min-w-14 h-full w-auto px-2 cursor-default'
      }
    })
    ...
    __VLS_elementAsFunction(
      ...
      ...{
        class:
          'border-slate-300 border-r border-y rounded-e-full w-8 h-full flex justify-center items-center cursor-pointer'
      },
      ...{ class: __VLS_ctx.currentPage === __VLS_ctx.totalPages ? 'bg-gray-100' : '' },
      disabled: __VLS_ctx.currentPage === __VLS_ctx.totalPages
    })
    __VLS_styleScopedClasses = currentPage === totalPages ? 'bg-gray-100' : ''
    // @ts-ignore
    const __VLS_18 = {}.ChevronRightIcon
    ;({}).ChevronRightIcon
  ...
  __VLS_elementAsFunction(
    __VLS_intrinsicElements.div,
    __VLS_intrinsicElements.div
  )({ ...{ class: 'content-table w-full h-full overflow-y-auto' } })
  __VLS_elementAsFunction(
  ...
  __VLS_elementAsFunction(
    ...
    __VLS_intrinsicElements.tr
  )({ ...{ class: 'bg-white font-semibold capitalize' } })
  ...
  if (__VLS_ctx.totalPages > 0) {
    ...
    __VLS_elementAsFunction(
      ...
      __VLS_intrinsicElements.td
    )({ colspan: '8', ...{ class: 'text-center py-10' } })
    __VLS_elementAsFunction(
      __VLS_intrinsicElements.span,
      __VLS_intrinsicElements.span
    )({ ...{ class: 'inline-flex flex-col items-center' } })
    // @ts-ignore
    const __VLS_24 = {}.InboxIcon
    ;({}).InboxIcon
    ...
    const __VLS_25 = __VLS_asFunctionalComponent(
      __VLS_24,
      new __VLS_24({ ...{ class: 'h-10 w-10 text-gray-300' } })
    )
