...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.header, __VLS_intrinsicElements.header)({ id: ("header"), ...{ class: ("py-3 px-6 rounded-md space-y-3") }, });
    __VLS_elementAsFunction(__VLS_intrinsicElements.h1, __VLS_intrinsicElements.h1)({ ...{ class: ("text-3xl font-bold uppercase text-[#F7C906] mb-6") }, });
    ...
    // @ts-ignore
    [handleStatus,];
    __VLS_elementAsFunction(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({ ...{ onClick: (__VLS_ctx.sendData) }, type: ("submit"), ...{ class: ("btn w-full bg-[#F7C906] rounded-md mt-3 font-semibold transition hover:border-none hover:bg-[#f7cb06c3] text-white hover:duration-300 hover:ease-in-out hover:bg-white hover:text-[#F7C906] hover:outline hover:outline-[1px] hover:outline-[#F7C906]") }, });
    // @ts-ignore
    [sendData,];
    ...
    if (typeof __VLS_styleScopedClasses === 'object' && !Array.isArray(__VLS_styleScopedClasses)) {
        ...
        __VLS_styleScopedClasses['hover:border-none'];
