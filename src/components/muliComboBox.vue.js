...
const { defineProps, defineSlots, defineExpose, defineModel, defineOptions, withDefaults } =
  await import('vue')
...
function __VLS_template() {
  ...
  __VLS_elementAsFunction(
    ...
    __VLS_intrinsicElements.div
  )({ ...{ class: 'grid grid-cols-1 md:gap-x-4 gap-y-4 relative md:grid-cols-2' } })
  __VLS_elementAsFunction(
    __VLS_intrinsicElements.div,
    __VLS_intrinsicElements.div
  )({ ...{ class: 'inline-flex w-full relative overflow-hidden h-11 rounded-md' } })
  __VLS_elementAsFunction(
    __VLS_intrinsicElements.div,
    __VLS_intrinsicElements.div
  )({
  ...
  __VLS_elementAsFunction(__VLS_intrinsicElements.input)({
    ...{
      class:
        'border-y border-l p-2 h-11 rounded-s-md text-sm focus:outline-1 focus:outline-[#f7c906]'
    },
    type: 'text',
    placeholder: 'Search...',
    value: __VLS_ctx.searchOffer
  })
  // @ts-ignore
  ;[searchOffer]
  __VLS_elementAsFunction(
    ...
    value: __VLS_ctx.selectedOfferId
  })
  __VLS_elementAsFunction(
  ...
  for (const [item] of __VLS_getVForSourceType(__VLS_ctx.filterOffer)) {
    __VLS_elementAsFunction(
      __VLS_intrinsicElements.option,
      __VLS_intrinsicElements.option
    )({ key: item.offering_id, value: item.offering_id })
  ...
  __VLS_elementAsFunction(
    __VLS_intrinsicElements.div,
    __VLS_intrinsicElements.div
  )({ ...{ class: 'inline-flex w-full relative overflow-hidden rounded-md' } })
  __VLS_elementAsFunction(
  ...
  __VLS_elementAsFunction(__VLS_intrinsicElements.input)({
    ...
    ...{
      class:
        'block w-full h-11 border border-gray-200 shadow-sm rounded-md text-sm focus:z-10 focus:border-[#f7c906] focus:ring-[#f7c906] disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 file:bg-gray-50 file:border-0 file:me-4 file:py-3 file:px-4 dark:file:bg-neutral-700 dark:file:text-neutral-400'
    }
  })
  // @ts-ignore
  ;[handleFileUpload]
  ...
  if (__VLS_ctx.historySelectedOfferId.length > 0) {
    ...
    for (const [item, i] of __VLS_getVForSourceType(__VLS_ctx.historySelectedOfferId)) {
      ...
      __VLS_elementAsFunction(
        ...
        ...{
          onClick: (...[$event]) => {
            if (!(__VLS_ctx.historySelectedOfferId.length > 0)) return
      ...
      const __VLS_1 = __VLS_asFunctionalComponent(
        __VLS_0,
        new __VLS_0({ ...{ class: 'h-5 w-5 fill-red-600 hover:fill-red-400' } })
      )
